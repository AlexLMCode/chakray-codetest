...
INSERT INTO addresses (name, street, country_code, user_id)
VALUES
  ('workaddress', 'street No. 1', 'UK', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890'),
  ('homeaddress', 'street No. 2', 'AU', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890'),
  ('workaddress', 'street No. 3', 'MX', 'b2c3d4e5-f6a7-8901-bcde-f12345678901');